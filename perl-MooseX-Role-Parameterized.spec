...
cp %{_builddir}/MooseX-Role-Parameterized-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-MooseX-Role-Parameterized/02baa9a7c1e8cd4e565c56a6af13a63d650805ef || :
if test -f Makefile.PL; then
